...
const PRODUCTS = [
  ...
  },
  {
    ...
    rating: 5,
    reviewsCount: 32,
    image: 'assets/images/hero-com-chay.jpg',
  ...
  },
  {
    ...
    rating: 4.8,
    reviewsCount: 19,
    image: 'assets/images/com-chay-mo-hanh.jpg',
  ...
  {
    id: 'set-qua-tang',
    name: 'Cơm Cháy Đáy Nồi Sốt Kho Quẹt (Đặc Sản Ninh Bình)',
    category: 'gift',
    ...
    rating: 5,
    reviewsCount: 38,
    image: 'assets/images/com-chay-kho-quet.jpg',
    shortDesc: 'Vòm cơm cháy đáy nồi tròn xốp vàng ươm nguyên tảng chấm cùng niêu kho quẹt tôm thịt ba chỉ đậm đà chuẩn vị quê nhà.',
    fullDesc: 'Món ăn đặc sản trứ danh đất Ninh Bình. Cơm cháy nguyên tảng nướng đáy nồi gang phồng rộp giòn tan, ăn kèm niêu kho quẹt tộ đất nóng hổi ngậy vị tóp mỡ, đậm đà tiêu ớt và tôm khô.',
    hasVariants: false,
    sku: 'CC-GIFT-06'
  }
];
